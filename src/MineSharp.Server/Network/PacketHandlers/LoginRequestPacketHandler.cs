...
public class LoginRequestPacketHandler : IClientPacketHandler<LoginRequestPacket>
{
    ...
    public async Task HandleAsync(LoginRequestPacket packet, ClientPacketHandlerContext context)
    {
        ...
        await context.Server.PluginManager.CallAsync(plugin => plugin.OnPlayerJoiningAsync(context.RemoteClient));
        ...
        await context.Server.PluginManager.CallAsync(plugin => plugin.OnPlayerInitializedAsync(context.RemoteClient));
        ...
        await context.Server.PluginManager.CallAsync(plugin => plugin.OnPlayerJoinedAsync(context.RemoteClient));
